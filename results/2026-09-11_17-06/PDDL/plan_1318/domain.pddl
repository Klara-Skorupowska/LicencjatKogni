(define (domain world)
  ...
  (:action Open_the_Door
    ...
    :effect (and (not (active_Open_the_Door)) (active_Find_the_Goal))
  )
  ...
  (:action Find_the_Goal
    ...
    :effect (and (not (active_Find_the_Goal)) (active_Open_the_Door) (active_Aproach_the_Door) (active_Find_the_Door) (active_Aproach_the_Goal))
  )
  ...
  (:action Start
    ...
    :effect (and (not (active_Start)) (active_Find_the_Goal) (active_Aproach_the_Door) (active_Find_the_Door))
  )
