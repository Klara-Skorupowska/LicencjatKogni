(define (domain world)
  ...
  (:action Find_the_Goal
    ...
    :effect (and (not (active_Find_the_Goal)) (active_Find_the_Door))
  )
  ...
  (:action Find_the_Door
    ...
    :effect (and (not (active_Find_the_Door)) (active_Open_the_Door) (active_Find_the_Goal) (active_Aproach_the_Door))
  )
